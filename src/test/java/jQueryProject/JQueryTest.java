...
//	Actions action = new Actions(driver);
	...
	public void JQueryUi_Widgets() throws Exception {
		...
		//public void Checkboxradio() throws InterruptedException{
		  ...
		  WebElement element = driver.findElement(By.xpath("//label[@for='radio-1']"));
		  boolean isRadioChecked = element.isSelected();		  
