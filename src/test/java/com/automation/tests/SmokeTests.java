...
public class SmokeTests extends BasePage {
	...
	public void searchAndBuyACourse() throws Exception {
		...
		WebElement scienceElem = driver.findElement(By.cssSelector("li.category-slide:nth-child(12) > a:nth-child(1) > img:nth-child(1)"));
		...
		WebElement videoDownloadElem = driver.findElement(By.cssSelector("div.format-block:nth-child(1) > label:nth-child(2)"));
		...
		// Synchronize the page load
		WebElement proceedToCheckOutElem = myLib.fluentWait(By.cssSelector("div.block-content:nth-child(1) > div:nth-child(3) > button:nth-child(2)"));
		Assert.assertNotNull(proceedToCheckOutElem);
		
		WebElement cartElem = driver.findElement(By.cssSelector(".mini-cart-js > span:nth-child(1) > span:nth-child(2)"));
		...
		WebElement noRadioBtn = driver.findElement(By.cssSelector(".checkout_login_content_cont_pwd > div:nth-child(1) > label:nth-child(2)"));
		noRadioBtn.click();
		
		WebElement continueElem = driver.findElement(By.cssSelector("#checkout-sigin"));
		continueElem.click();
		
		/*WebElement dynamicElement = myLib.dynamicWait_presenceOfElementLocated(By.id("billing:firstname"));
		...
		*/
		...
		/*
		 * WebElement next = navNextElem.findElement(By.tagName("a")); for(int i
		 * = 1; i <=3; i++){ myLib.clickInvisibleWebElement(next);
		 * myLib.customWait(0.5);
		 */
